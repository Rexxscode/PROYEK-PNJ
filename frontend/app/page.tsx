...
const stats = [
  { value: 248, suffix: "+", label: "Siswa Terdaftar", icon: Users },
  { value: 85, suffix: "%", label: "Match Rate", icon: Target },
  { value: 50, suffix: "+", label: "Lowongan Tersedia", icon: Building2 },
...
export default function Home() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 lg:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <Reveal whenVisible={false} delay={0} className="space-y-8">
            ...
            <Reveal whenVisible={false} delay={120} className="mt-8 lg:mt-0">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {[
                        ...
                        <div key={item.label} className="rounded-xl p-3 text-center bg-primary/5 border border-primary/20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <Reveal key={feature.title} delay={index * 100}>
                <div
                  className="group bg-card border border-border rounded-2xl p-6 h-full hover:shadow-xl hover:border-primary/20 transition-all duration-300 hover:-translate-y-1"
                >
      ...
      {/* Stats Section */}
      <section id="stats" className="py-12 sm:py-20 bg-white dark:bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-12 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="relative bg-primary rounded-3xl p-6 sm:p-10 lg:p-12 text-center overflow-hidden">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-12 sm:py-20 bg-white dark:bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
              Kontak Kami
            ...
            <p className="text-muted max-w-2xl mx-auto">
              Punya pertanyaan, saran, atau ingin bekerja sama? Hubungi tim SkillMatch melalui informasi di bawah ini.
            </p>
          </Reveal>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Reveal delay={0}>
              <Card className="text-center p-8 h-full">
                ...
                <p className="text-sm text-muted">SkillMatchInfoo@gmail.com</p>
              </Card>
            </Reveal>
            <Reveal delay={120}>
              <Card className="text-center p-8 h-full">
            ...
            <Reveal delay={240}>
              <Card className="text-center p-8 h-full">
                ...
                <h3 className="font-semibold text-foreground mb-2">Respon</h3>
                <p className="text-sm text-muted">Kami balas dalam 1-2 hari kerja</p>
              </Card>
            </Reveal>
          </div>
        </div>
          ...
          <Reveal>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted">
                ...
                <li>
                  <a href="#" className="hover:text-primary transition-colors">Tim Kami</a>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted">
                <li>
                  <a href="#contact" className="hover:text-primary transition-colors">Hubungi Kami</a>
                </li>
