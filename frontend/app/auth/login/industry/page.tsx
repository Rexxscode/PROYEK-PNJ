    ...
    <div className="min-h-screen flex items-center justify-center bg-primary/5 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">Login Perusahaan / Industry</h1>
          <p className="text-sm text-muted mt-2">Masuk untuk mengelola lowongan dan kandidat.</p>
        </div>
