...
"[project]/frontend/app/lib/major-quiz.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const tkjQuiz = [
    ...
    },
    {
        ...
        options: [
            "DRSR (Directory Replication Service RPC)",
            "SMB",
            "WinRM",
            "WMI",
            "SNMP"
    ...
    },
    {
        ...
        options: [
            "Nilai variabel",
            "Exit status dari perintah terakhir yang dieksekusi",
            "Jumlah argumen",
            "Nama user saat ini",
    ...
    },
    {
        ...
        options: [
            "read -p 'Masukkan input: ' variabel",
            "input 'Masukkan input: ' variabel",
            "get 'Masukkan input: ' variabel",
            "scan 'Masukkan input: ' variabel",
            "ask 'Masukkan input: ' variabel"
        ],
        correct: 4,
        difficulty: "expert",
        skill: "Shell Scripting"
...
const transmisiQuiz = [
    ...
    },
    {
        ...
        options: [
            ...
            "Menerjemahkan alamat IP ke alamat MAC",
            "Mengatur koneksi TCP",
            "Mengenkripsi data yang dikirim",
            "Mengatur routing paket data"
        ],
        correct: 1,
        difficulty: "intermediate",
        skill: "Networking Basics"
    ...
    },
    {
        ...
        options: [
            "interface f0/0; ip address 192.168.1.1 255.255.255.0; shutdown",
            "interface f0/0; ip address 192.168.1.1 255.255.255.0; no shutdown",
            "ip interface f0/0 192.168.1.1 255.255.255.0",
            "set ip f0/0 192.168.1.1 255.255.255.0",
            "configure ip f0/0 192.168.1.1/24"
        ],
        correct: 1,
        difficulty: "intermediate",
        skill: "Cisco IOS"
    },
    {
        ...
        options: [
            "banner message 'Selamat Datang'",
            "banner login #Selamat Datang#",
            "set banner selamat datang",
            "login banner welcome",
            "message-of-the-day selamat datang"
        ],
        correct: 1,
        difficulty: "intermediate",
        skill: "Cisco IOS"
    },
    {
        ...
        options: [
            "ip dhcp pool NAME; network NETWORK SUBNET; default-router GATEWAY",
            "dhcp pool create NAME; set network; set gateway",
            "service dhcp; pool NAME; ip network",
            "dhcp server NAME; add network; add gateway",
            "ip dhcp server NAME network SUBNET"
        ],
        correct: 0,
        difficulty: "intermediate",
        skill: "Cisco IOS"
    },
    {
        ...
        options: [
            ...
            "privileged password mypassword",
            "secret enable mypassword",
    ...
    },
    {
        ...
        options: [
            ...
            "nat static add LOCAL_IP PUBLIC_IP",
            "ip nat static map LOCAL_IP to PUBLIC_IP",
            "static nat translate LOCAL_IP PUBLIC_IP",
            "ip nat inside static LOCAL_IP PUBLIC_IP"
        ],
        correct: 0,
        difficulty: "advanced",
        skill: "Cisco IOS"
    ...
    },
    {
        ...
        options: [
            "router ospf 1; network IP_AREA AREA",
            "ip ospf process area AREA interface IF",
            "ospf enable area AREA on interface",
            "routing ospf 1; area AREA interface IF",
    ...
    },
    {
        ...
        options: [
            "Peningkatan intensitas cahaya seiring jarak",
            "Penurunan kekuatan sinyal cahaya seiring jarak",
            "Pemantulan cahaya di dalam core",
            "Distorsi sinyal akibat chromatic dispersion",
            "Kehilangan sinyal akibat connectors yang longgar"
        ],
        correct: 1,
        difficulty: "advanced",
        skill: "Fiber Optics"
    ...
    },
    {
        ...
        options: [
            "/ip route dengan multiple gateways",
            "/interface bonding",
            "/routing bgp",
            "/ip dhcp-client",
            "/ip firewall nat"
    ...
    },
    {
        ...
        options: [
            "Ukuran antena dan line of sight (LoS)",
            "Jumlah client yang terkoneksi",
            "Kecepatan clock processor AP",
            "Tipe kabel yang digunakan",
            "Jumlah SSID yang dikonfigurasi"
        ],
        correct: 0,
        difficulty: "expert",
        skill: "Wireless Technology"
    ...
    },
    {
        ...
        options: [
            "Memutuskan koneksi internet korban",
            "Memetakan ulang alamat MAC ke alamat IP pada ARP cache korban",
            "Mengenkripsi lalu lintas jaringan korban",
            "Memperlambat kecepatan transfer data korban",
            "Menghapus tabel routing pada router korban"
        ],
        correct: 1,
        difficulty: "advanced",
        skill: "Network Security"
    ...
    },
    {
        ...
        options: [
            ...
            "iptables -t mangle -A FORWARD -i eth0 -j DROP",
            "iptables -t raw -A PREROUTING -i eth0 -j REDIRECT",
            "iptables -t security -A OUTPUT -o eth0 -j LOG"
        ],
        correct: 0,
        difficulty: "expert",
        skill: "Linux"
    },
    {
        ...
        options: [
            "Mengelola file system dan mount point",
            "Mengelola layanan dan unit sistem secara paralel",
            "Mengelola jaringan dan firewall",
            "Mengelola user authentication",
            "Mengelola file permission"
        ],
        correct: 1,
        difficulty: "expert",
        skill: "Linux"
    ...
    },
    {
        ...
        options: [
            "Mengatur routing panggilan antar ekstensi",
            "Menyimpan recording panggilan",
            "Mengirim email notifikasi",
            "Mengatur firewall jaringan",
            "Mengelola database pengguna"
        ],
        correct: 0,
        difficulty: "intermediate",
        skill: "VoIP"
    ...
    },
    {
        ...
        options: [
            "64 Kbps dengan kompresi ADPCM",
            "64 Kbps tanpa kompresi (PCM)",
            "32 Kbps dengan kompresi ADPCM",
            "8 Kbps dengan kompresi CS-ACELP",
            "16 Kbps dengan kompresi LD-CELP"
        ],
        correct: 1,
        difficulty: "advanced",
        skill: "VoIP"
    ...
    },
    {
        ...
        options: [
            "Koneksi terputus",
            "Munculnya delay yang terdengar dan jitter",
    ...
    },
    {
        ...
        options: [
            "Menghubungkan PBX ke PSTN melalui internet menggunakan protokol SIP",
            "Menghubungkan IP Phone langsung ke PSTN",
            "Membuat jalur dedicated melalui kabel fiber",
            "Menggunakan satellite link untuk panggilan internasional",
            "Menghubungkan dua PBX melalui jaringan telepon analog"
        ],
        correct: 0,
        difficulty: "expert",
        skill: "VoIP"
    ...
    },
    {
        ...
        options: [
            "Merekam audio di area surveilans",
            "Mengontrol gerakan kamera secara horizontal, vertikal, dan zoom",
            "Menyimpan video secara lokal",
            "Menghubungkan kamera ke internet",
            "Memberikan daya listrik ke kamera"
        ],
        correct: 1,
        difficulty: "intermediate",
        skill: "CCTV & Surveillance"
    ...
    },
    {
        ...
        options: [
            ...
            "Video Analytics - Line Crossing Detection",
            "Video Analytics - Face Recognition",
            "Video Analytics - Object Classification",
    ...
    },
    {
        ...
        options: [
            ...
            "Memastikan kompatibilitas antara perangkat CCTV dari vendor berbeda",
    ...
    },
    {
        ...
        options: [
            "Menyimpan backup video ke cloud",
            "Menggantikan server utama jika terjadi kegagalan untuk memastikan kontinuitas operasi",
            "Mengatur bandwidth jaringan",
            "Mengontrol akses pengguna",
            "Mengelola kamera secara terpusat"
        ],
        correct: 1,
        difficulty: "expert",
        skill: "CCTV & Surveillance"
...
function getMajorQuizStorageKey(major) {
    return `${MAJOR_QUIZ_OVERRIDE_PREFIX}${major.toLowerCase().trim().replace(/\s+/g, "-")}`;
}
function readMajorQuizOverride(major) {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    try {
...
function hasMajorQuizOverride(major) {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
...
function getQuizForMajor(major) {
    const over = readMajorQuizOverride(major);
    if (over && over.length > 0) return over;
...
async function fetchMajorQuizAdmin(major) {
    const url = major ? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2d$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BACKEND_ENDPOINTS"].assessment.adminQuestions(major) : __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2d$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BACKEND_ENDPOINTS"].assessment.adminQuestions();
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["api"].get(url);
...
async function saveMajorQuizAdmin(major, questions) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["api"].put(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2d$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BACKEND_ENDPOINTS"].assessment.update(major), {
...
async function resetMajorQuizAdmin(major) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["api"].post(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2d$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BACKEND_ENDPOINTS"].assessment.reset(major));
    return true;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/frontend/app/lib/notifications.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getNotificationsFor(role, email) {
    try {
        ...
        if (!res.success) return [];
        return res.data.filter((n)=>!n.role || n.role === role).filter((n)=>!n.target_email || !email || n.target_email === email).map((n)=>({
                id: n.id,
                text: n.text,
                time: n.created_at ?? "",
...
async function markAllAsRead(_role, _email) {
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["api"].post(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2d$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BACKEND_ENDPOINTS"].notifications.markAllRead);
    } catch  {
    // ignore
...
"[project]/frontend/app/student/assessment/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/frontend/app/lib/api.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2d$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/app/lib/api-contract.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/app/lib/notifications.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$major$2d$quiz$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/app/lib/major-quiz.ts [app-client] (ecmascript)");
...
;
;
const SkillRadar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/frontend/app/components/charts/skillradar.tsx [app-client] (ecmascript, next/dynamic entry, async loader)"), {
    loadableGenerated: {
        modules: [
            "[project]/frontend/app/components/charts/skillradar.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    },
    ssr: false
});
...
function getLevelFromScore(correct, total) {
...
function AssessmentPage() {
    ...
    const [quizAnswers, setQuizAnswers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [quizCurrent, setQuizCurrent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const [quizQuestions, setQuizQuestions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [resultSkills, setResultSkills] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AssessmentPage.useEffect": ()=>{
            ...
            let cancelled = false;
            const load = {
                "AssessmentPage.useEffect.load": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2d$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BACKEND_ENDPOINTS"].assessment.questions(major));
                        if (cancelled) return;
                        if (res.success && res.data.length > 0) {
                            setQuizQuestions(res.data.map({
                                "AssessmentPage.useEffect.load": (q)=>({
                                        ...q,
                                        id: String(q.id)
                                    })
                            }["AssessmentPage.useEffect.load"]));
                            setLoadError(null);
                        } else {
                            setQuizQuestions([]);
    ...
    if (!mounted || !user) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SkeletonDashboard"], {}, void 0, false, {
            fileName: "[project]/frontend/app/student/assessment/page.tsx",
            lineNumber: 110,
            columnNumber: 54
        }, this)
    }, void 0, false, {
    ...
    const goToStep = async (step)=>{
        if (step === 3) {
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$major$2d$quiz$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gradeQuiz"])(quizAnswers, quizQuestions);
            setQuizResult(result);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$major$2d$roadmap$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveQuizResult"])(result);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$major$2d$roadmap$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveQuizAnswers"])(quizAnswers);
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["api"].post(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$api$2d$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BACKEND_ENDPOINTS"].assessment.submit, {
            ...
            const careerMatches = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$career$2d$match$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateCareerMatches"])(majorName, result);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$career$2d$match$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveCareerMatches"])(careerMatches);
            const skills = Object.entries(result.skillScores).map(([skillName, data])=>({
                    id: `skill-${skillName}`,
                    name: skillName,
                    category: "hard",
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$lib$2f$notifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addNotification"])({
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Selesaikan Kartu Pelajar agar bisa mengikuti asesmen dan melihat hasil level skill serta rekomendasi karier."
                        }, void 0, false, {
                            fileName: "[project]/frontend/app/student/assessment/page.tsx",
                            lineNumber: 166,
                            columnNumber: 11
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: stepLabels.map((label, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex flex-col items-center gap-1",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: `w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${currentStep > i + 1 ? "bg-emerald-500 text-white" : currentStep === i + 1 ? "bg-primary text-white" : "bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400"}`,
                                        children: currentStep > i + 1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle2$3e$__["CheckCircle2"], {
                                            className: "w-4 h-4"
                                        }, void 0, false, {
                                            fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                            lineNumber: 199,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: `text-[10px] sm:text-xs text-center ${currentStep === i + 1 ? "font-medium text-foreground" : "text-muted"}`,
                                        children: label
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                        lineNumber: 201,
            ...
            currentStep === 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                className: "text-center py-8 sm:py-12 animate-fade-in",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Asesmen ini akan memetakan kemampuan skill kamu melalui tes pengetahuan jurusan. Hasil tes akan menentukan level skill hard skill kamu secara objektif."
                    }, void 0, false, {
                        fileName: "[project]/frontend/app/student/assessment/page.tsx",
                        lineNumber: 222,
                        columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-amber-50 dark:bg-amber-900/30 rounded-lg px-4 py-2 text-center",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm font-medium text-amber-700 dark:text-amber-300",
                                        children: quizLoaded ? `${quizQuestions.length} Soal Tes Jurusan` : "Tes Jurusan"
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                        lineNumber: 228,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: majorName || currentUser.major
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                        lineNumber: 229,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-blue-50 dark:bg-blue-900/30 rounded-lg px-4 py-2 text-center",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-sm font-medium text-blue-700 dark:text-blue-300",
                                    children: "10 Soal per Hard Skill"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                    lineNumber: 232,
                                    columnNumber: 15
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-xs text-muted text-center mb-8",
                        children: "Jawab seluruh soal bank tes jurusanmu. Hasil menentukan level hard skill dan rekomendasi karier."
                    }, void 0, false, {
                        fileName: "[project]/frontend/app/student/assessment/page.tsx",
                        lineNumber: 235,
                        columnNumber: 11
            ...
            currentStep === 2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    loadError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Soal tidak dapat dimuat"
                            }, void 0, false, {
                                fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                lineNumber: 253,
                                columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-sm text-muted mt-1 mb-4",
                                children: loadError
                            }, void 0, false, {
                                fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                lineNumber: 254,
                    ...
                    !loadError && !quizLoaded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    !loadError && quizLoaded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                                ...
                                                children: "Tes Pengetahuan Jurusan"
                                            }, void 0, false, {
                                                fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                                lineNumber: 272,
                                                columnNumber: 15
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: [
                                                    majorName || currentUser.major,
                                                    " — ",
                                                    quizQuestions.length,
                                                    " soal dari dasar hingga ahli"
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                                lineNumber: 273,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...new Set(quizQuestions.map((q)=>q.skill))
                                ].map((skill)=>{
                                    const qs = quizQuestions.filter((q)=>q.skill === skill);
                                    const answered = qs.filter((q)=>quizAnswers[q.id] !== undefined).length;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "px-3 py-1 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-700 text-muted",
                                        children: [
                                            skill,
                                            ": ",
                                            answered,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 mb-6",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                    variant: difficultyColor[q.difficulty],
                                                    className: "text-[10px]",
                                                    children: difficultyLabel[q.difficulty]
                                                }, void 0, false, {
                                                    fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                                    lineNumber: 308,
                                                    columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-2",
                                            children: q.options.map((opt, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    onClick: ()=>handleQuizAnswer(q.id, i),
                                                    className: `w-full text-left px-4 py-3 rounded-xl text-sm border transition-colors ${selectedAnswer === i ? "border-primary bg-primary/10 text-primary font-medium" : "border-border text-foreground hover:bg-gray-50 dark:hover:bg-gray-700"}`,
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            ...
                                            " ",
                                            quizCurrent > 0 ? "Sebelumnya" : "Kembali"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                        lineNumber: 336,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: quizCurrent < quizQuestions.length - 1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            currentStep === 3 && (resultSkills.length > 0 || quizResult) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "animate-fade-in",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Skill profile kamu sudah berhasil dibuat berdasarkan hasil tes."
                                        }, void 0, false, {
                                            fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                            lineNumber: 379,
                                            columnNumber: 17
                    ...
                    quizResult && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: Object.values(quizResult.skillScores).filter((s)=>s.correct === s.total).length
                                            }, void 0, false, {
                                                fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                                lineNumber: 403,
                                                columnNumber: 19
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-2",
                                children: Object.entries(quizResult.skillScores).map(([skill, data])=>{
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-muted w-10 text-right",
                                                        children: [
                                                            data.correct,
                                                            "/",
                                                            data.total
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SkillRadar, {
                                    skills: resultSkills,
                                    title: "Skill Profile Kamu"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                    lineNumber: 436,
                                    columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-3",
                                        children: resultSkills.sort((a, b)=>b.level - a.level).map((skill)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: `w-2 h-2 rounded-full ${skill.level >= 4 ? "bg-emerald-500" : skill.level >= 3 ? "bg-amber-400" : "bg-red-400"}`
                                                            }, void 0, false, {
                                                                fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                                                lineNumber: 446,
                                                                columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    5
                                                                        ...
                                                                        className: `w-3 h-3 rounded-sm ${i <= skill.level ? "bg-primary" : "bg-gray-200 dark:bg-gray-700"}`
                                                                    }, i, false, {
                                                                        fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                                                        lineNumber: 452,
                                                                        columnNumber: 29
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                                ...
                                                                className: "text-[10px]",
                                                                children: getLevelLabel(skill.level)
                                                            }, void 0, false, {
                                                                fileName: "[project]/frontend/app/student/assessment/page.tsx",
                                                                lineNumber: 460,
                                                                columnNumber: 25
...
_s(AssessmentPage, "NpTxdvSp1jeXgA5fVW65NjtVYiE=", false, function() {
    return [
...
//# sourceMappingURL=frontend_app_0m5vjw0._.js.map