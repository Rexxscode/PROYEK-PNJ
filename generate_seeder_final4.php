...
foreach ($questions as $q) {
    $id = $q['id'];
    $major = $q['major'];
    $question = json_encode($q['question']);  // Use json_encode for question too
    $correct = $q['correct'];
    ...
    $seederCode .= "            ['id' => '$id'],\n";
    $seederCode .= "            ['major_id' => '$major', 'question' => $question, 'options' => $optionsJson, 'correct' => {$q['correct']}, 'difficulty' => '{$q['difficulty']}', 'skill' => '{$q['skill']}']\n";
    $seederCode .= "        );\n";
}
